...
export const CookieComponent = () =>{
    ...
    return(<
        ...
        >
          ...
          <span>This app uses cookies to enhance your experience. By continuing to use this app, you are consenting to our use of cookies. Learn more about the </span> 

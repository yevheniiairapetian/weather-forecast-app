...
export const CookieComponent = () =>{
    ...
    return(<
        ...
        >
          ...
          <span>This app uses cookies to make your experience while navigating it more comfortable. This applies to features including (but not limited to) setting a theme color or language preferences. By continuing to use this app, you are consenting to our use of cookies. Learn more about the </span> 
